        ...
        for (var i = 0; i < table.rowCount; i++) {
            ...
            if (vatData.vatCode) {
                if (vatData.vatCode && vatData.gr1) {
                    ...
                    var msg = this.getErrorMessage(this.VATCODE_WITHOUT_GR1, lang, vatData.vatCode);
    ...
    getErrorMessage(errorId, lang, vatCode) {
        ...
        switch (errorId) {
            case this.VATCODE_WITHOUT_GR1:
                if (lang == "nl")
                    return "Aan de volgende BTW code: " + vatCode + " is geen Gr1 toegewezen, controleer dit in uw BTW-codes tabel"
                else
